  ...
  return (
    ...
    >
      {result.coinSide === COIN_SIDE.ETH ? (
        <img src={`${CDN_URL}/coin-flip-2d/eth.png`} width={20} height={20} alt="eth_icon" />
      ) : (
        <img src={`${CDN_URL}/coin-flip-2d/btc.png`} width={20} height={20} alt="btc_icon" />
      )}
...
export const CoinFlipLastBets: React.FC = () => {
  ...
  return (
    <section className="wr-absolute wr-left-1/2 wr-top-5  wr-flex wr-max-w-full -wr-translate-x-1/2 wr-items-center wr-justify-end wr-gap-[6px] wr-overflow-hidden">
