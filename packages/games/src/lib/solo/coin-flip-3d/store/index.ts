...
export type CoinFlip3dGameStore = CoinFlip3dGameState & CoinFlip3dGameStateActions;
...
export const coinFlip3dResultStore = create<CoinFlip3dGameStore>()((set) => ({
  ...
  updateCoinFlip3dGameResults: (item) => set(() => ({ coinFlipGameResults: item })),
  clearStore: () =>
    set({
      lastBets: [],
      coinFlipGameResults: [],
...
export const useCoinFlip3dGameStore = <T extends keyof CoinFlip3dGameStore>(keys: T[]) =>
