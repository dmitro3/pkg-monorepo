...
export const VideoPokerResults = () => {
  ...
  return (
    <section className="wr-w-full max-lg:wr-absolute max-lg:wr-bottom-0 max-lg:wr-left-0 max-lg:wr-bg-black wr-z-20 max-lg:wr-p-4 max-lg:wr-py-2 max-lg:wr-border-t max-lg:wr-border-zinc-800 ">
