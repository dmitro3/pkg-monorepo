...
const CrashParticipant = () => {
  ...
  return (
    <>
      <div className="wr-absolute wr-right-0 wr-top-[990px] wr-z-10 wr-w-full wr-px-[14px] wr-font-dewi wr-font-semibold md:wr-right-8 md:wr-top-10 md:wr-max-w-[288px] md:wr-px-0">
        <div className="wr-mb-[23px] wr-flex wr-items-center wr-justify-between wr-rounded-md wr-bg-[#FFFFFF14] wr-p-1.5 wr-pr-[23px] wr-text-[13px]">
          <div className="wr-flex wr-items-center wr-gap-1.5 wr-font-semibold ">
            <Coins />
            Total bank
          </div>
          <div className="wr-flex wr-items-center wr-gap-1.5 wr-font-semibold">
        ...
        <div className="wr-mb-3 wr-flex wr-justify-between wr-pr-[78px] wr-text-xs wr-font-semibold">
          <div>USER</div>
          <div>BET</div>
        </div>
        {participants.length ? (
