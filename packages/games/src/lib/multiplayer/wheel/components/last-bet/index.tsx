...
import { colorMultipliers, multiplierColors, WheelColor } from '../../constants';
        ...
        <div
          className={cn(
            'wr-flex wr-h-[28px] wr-items-center wr-justify-center wr-rounded-[200px] wr-px-2 wr-py-1.5 wr-font-semibold',
            {
              ...
              'wr-bg-blue-600': `${colorMultipliers[String(h.color) as WheelColor]}x` === '3x',
              'wr-bg-green-500': `${colorMultipliers[String(h.color) as WheelColor]}x` === '6x',
              'wr-bg-red-600': `${colorMultipliers[String(h.color) as WheelColor]}x` === '48x',
            }
          )}
          key={i}
