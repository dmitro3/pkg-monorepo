...
interface Web3AuthConnectorParams {
...
export type SmartWalletConnectorWagmiType = "Web3Auth";
...
export function Web3AuthConnector(parameters: Web3AuthConnectorParams) {
  ...
  return createConnector<Provider>((config) => ({
    ...
    type: "Web3Auth" as SmartWalletConnectorWagmiType,
      ...
      try {
        ...
        if (!provider)
          throw new UserRejectedRequestError(
            "Provider not found" as unknown as Error
          );
